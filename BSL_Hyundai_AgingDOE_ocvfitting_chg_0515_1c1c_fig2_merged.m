...
%     xline(0)
    ...
    h =legend('FC','PE','FC-Simulation', 'NE', 'Location', 'northeast','Box','off','NumColumns', 2);
...
%     xlabel('SOC');  % x축 레이블
%     ylabel('dV/dQ [V/mAh] \times10');
%     h =legend('FC','PE','FC-SIM', 'NE', 'Location', 'northeast','Box','off','NumColumns', 2);
%     h.ItemTokenSize(1) = 15;
%     h.FontSize = 4;
% 
%         % Set Y lim
