...
h1 = plot(x_fine, y_smooth,'Color','b'); hold on;
...
h2 = plot(x_fine, y_smooth,'Color','r'); 
...
h3 = plot(data_merged3.data.cycles, data_merged3.data.SOH);
...
h = legend([hLegend, h1, h2],{'Loss by LLI', 'Loss by LAMp', 'Loss by R', '1C Loss', 'QC Loss', }, 'Location', 'SouthWest', 'Box', 'on');
